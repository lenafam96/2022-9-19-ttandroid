...
public class CustomAdapter_VD3 extends BaseAdapter {
    Context context;
    String[] list;
    int[] avatars;
    LayoutInflater inflater;

    public CustomAdapter_VD3(Context context, String[] idol, int[] avatar) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.gridview_vd3, parent, false);
